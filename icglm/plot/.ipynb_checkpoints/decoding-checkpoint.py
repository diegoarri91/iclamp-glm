...
class DecodingPlotter:
    ...
    def plot_decoded_stimulus(self, ax_raster=None, axI=None, t0=None, tf=None, stim_kwargs=None):
        ...
        SpikeTrainsPlotter(self.t, self.mask_spikes).plot(ax=ax_raster, t0=t0, tf=tf)

        # for n in range(n_neurons):
        #     st = SpikeTrain(self.t[arg0:argf], self.mask_spikes[n][arg0:argf])
        ...
        if self.var_stim_dec is not None:
            ...
            axI.fill_between(self.t[arg0:argf], self.stim_dec[arg0:argf] - sd, self.stim_dec[arg0:argf] + sd, color='C1', alpha=.4, zorder=2)
