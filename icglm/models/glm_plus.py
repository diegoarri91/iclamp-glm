...
class GLMplus2(BayesianSpikingModel):
    ...
    def sample(self, t, stim, stim_h=0, full=False):
        ...
        quad_kappa_conv = self.quad_kappa.convolve_continuous(t, stim ** 2)
    ...
    def gh_log_prior_kernels(self, theta):
        ...
        n_quad_kappa = self.quad_kappa.nbasis
        log_prior = 0
    ...
    def get_theta(self):
        ...
        theta[1 + n_kappa + n_eta:] = self.quad_kappa.coefs
        return theta
    ...
    def get_likelihood_kwargs(self, t, stim, mask_spikes, stim_h=0):
        ...
        X_quad_kappa = self.quad_kappa.convolve_basis_continuous(t, stim**2)
    ...
    def set_params(self, theta):
        ...
        self.quad_kappa.coefs = theta[1 + n_kappa + n_eta:]
        return self
